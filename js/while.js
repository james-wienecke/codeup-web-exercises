...
do {
    ...
    if (allCones < 0) {
        console.log("Cannot sell", boughtCones, "cone(s). I only have", allCones + boughtCones, "cone(s) left.")
    } else {
        console.log("Yay,", boughtCones, "cone(s) bought.", allCones, "cone(s) remain.");
    }
} while (allCones >= 0);