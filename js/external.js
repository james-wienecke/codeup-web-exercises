...
// collect user input
var daysRentedMermaid = prompt("How nights have you rented 'The Little Mermaid?'?");
...
var moviesTotalRentalDays = Number(daysRentedMermaid) + Number(daysRentedBrotherBear) + Number(daysRentedHercules);
...
// calculate total pay
var contractorTotalPay = wageGoogle * Number(hoursGoogle) + wageAmazon * Number(hoursAmazon) + wageFacebook * Number(hoursFacebook);
// display total
alert("You earned a total of $" + contractorTotalPay + " for your work.");
...
// collect user input
var offerCountItems = prompt("How many items in the purchase?");
var offerExpires = confirm("Is offer still valid?");
var offerPremium = confirm("Premium member?");
// logic for offer eligibility
var offerValid = offerExpires && (offerPremium || (Number(offerCountItems) > 2));
// display results
if (offerValid) {
