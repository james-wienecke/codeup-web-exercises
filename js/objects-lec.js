...
(function () {
    ...
    let company = {
        name: "Massive Industrial Co.",
        location: {
            city: "San Antonio",
            state: "Texas",
            country: "USA"
        },
        numberOfEmployees: 1673,
        industry: "construction",
        founder: {
            first: "Joline",
            last: "Davids"
        },
        foundingInfo: function () {
            console.log(`${this.name} was established by ${this.founder.first} ${this.founder.last}.`);
            console.log(`${this.name} has its headquarters in ${this.location.city} ${this.location.state}, ${this.location.country}.`);
            console.log(`It has ${this.numberOfEmployees} employees and is a sizable player in the ${this.industry} field`);
